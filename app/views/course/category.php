    ...
    <div class="container">
        <div class="course-nav">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb pb-2">
                    ...
                    <li class="breadcrumb-item"><a href="/course/choose#<?= $type ?>"><?= $type ?></a></li>
                    <li class="breadcrumb-item text-orange"  aria-current="page"><?= COURSE_CATEGORY[$category] ?></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="mt-5 text-center">
            <a href="/course/choose">
                <button class="btn bg-orange">返回課程分類</button>
            </a>
        </div>
    </div>
</section>